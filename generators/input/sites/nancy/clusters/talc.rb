  ...
  cluster :talc do |cluster_uid|
    ...
    92.times do |i|
      node "#{cluster_uid}-#{i+1}" do |node_uid|
        ...
        {
          :interface        => lookup('talc_generated', node_uid, 'network_interfaces', 'ib0', 'interface'),
          :rate             => lookup('talc_generated', node_uid, 'network_interfaces', 'ib0', 'rate'),
          :device           => "ib0",
          :enabled          => lookup('talc_generated', node_uid, 'network_interfaces', 'ib0', 'enabled'),
          :management       => lookup('talc_generated', node_uid, 'network_interfaces', 'ib0', 'management'),
          :mountable        => lookup('talc_generated', node_uid, 'network_interfaces', 'ib0', 'mountable'),
          :mounted          => lookup('talc_generated', node_uid, 'network_interfaces', 'ib0', 'mounted'),
          :vendor           => 'Mellanox',
          :version          => lookup('talc_generated', node_uid, 'network_interfaces', 'ib0', 'version'),
          :driver           => lookup('talc_generated', node_uid, 'network_interfaces', 'ib0', 'driver'),
          :network_address  => "#{node_uid}-ib0.#{site_uid}.grid5000.fr",
          :ip               => lookup('talc_generated', node_uid, 'network_interfaces', 'ib0', 'ip'),
          :ip6               => lookup('talc_generated', node_uid, 'network_interfaces', 'ib0', 'ip6'),
          :guid             => lookup('talc_generated', node_uid, 'network_interfaces', 'ib0', 'guid'),
          :switch           => "stalcib",
        },
        {
          :interface        => lookup('talc_generated', node_uid, 'network_interfaces', 'ib1', 'interface'),
          :rate             => lookup('talc_generated', node_uid, 'network_interfaces', 'ib1', 'rate'),
          :device           => "ib1",
          :enabled          => lookup('talc_generated', node_uid, 'network_interfaces', 'ib1', 'enabled'),
          :management       => lookup('talc_generated', node_uid, 'network_interfaces', 'ib1', 'management'),
          :mountable        => lookup('talc_generated', node_uid, 'network_interfaces', 'ib1', 'mountable'),
          :mounted          => lookup('talc_generated', node_uid, 'network_interfaces', 'ib1', 'mounted'),
          :vendor           => 'Mellanox',
          :version          => lookup('talc_generated', node_uid, 'network_interfaces', 'ib1', 'version'),
          :driver           => lookup('talc_generated', node_uid, 'network_interfaces', 'ib1', 'driver'),
          :guid             => lookup('talc_generated', node_uid, 'network_interfaces', 'ib1', 'guid')
        },
        {
          :interface            => 'Ethernet',
          :rate                 => 100.M,

    ...
    13.times do |i|
      node "#{cluster_uid}-#{i+1}" do |node_uid|
        ...
        network_adapters [{
          ...
          :version          => "NetXtreme II BCM5708 Gigabit Ethernet",
          ...
          :switch           => net_switch_lookup('sophia', 'uva', node_uid),
          :switch_port      => net_port_lookup('sophia', 'uva', node_uid),
        ...
        },
        {
          ...
          :rate             => 1.G,
          :enabled          => false, #lookup(node_uid, node_uid, 'network_interfaces', 'eth2', 'enabled'),
          :management       => lookup(node_uid, node_uid, 'network_interfaces', 'eth2', 'management'),
          :mountable        => false, #lookup(node_uid, node_uid, 'network_interfaces', 'eth2', 'mountable'),
        ...
        },
        {
          ...
          :rate             => 1.G,
          :enabled          => false, #lookup(node_uid, node_uid, 'network_interfaces', 'eth3', 'enabled'),
          :management       => lookup(node_uid, node_uid, 'network_interfaces', 'eth3', 'management'),
          :mountable        => false, #lookup(node_uid, node_uid, 'network_interfaces', 'eth3', 'mountable'),
          ...
          :ip               => lookup(node_uid, node_uid, 'network_interfaces', 'eth3', 'ip'),
        ...
        },
        {
          ...
          #:hwid             => lookup('uva_manual', node_uid, 'network_interfaces', 'ib0', 'hwid'),
          :switch           => "ibswy2nef",
          #:ib_switch_card   => lookup('uva_manual', node_uid, 'network_interfaces', 'ib0', 'line_card'),
          #:ib_switch_card_pos => lookup('uva_manual', node_uid, 'network_interfaces', 'ib0', 'position'),
        },
        {
          :interface => 'Ethernet',
          :rate => 100.M,
          :network_address  => "#{node_uid}-bmc.#{site_uid}.grid5000.fr",
          :ip => "172.17.131.#{i+1}", #lookup(node_uid, node_uid, 'network_interfaces','bmc', 'ip'),
